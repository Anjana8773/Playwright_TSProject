...
> 20 |      expect(page.locator('#nameofuser')).toHaveText(`Welcome ${username}`)
  ...
  40 |      const creditcard=getCellData(3,4)
  41 |      const month=getCellData(3,5)
  42 |      const year=getCellData(3,6)    
  43 | 
  ...
  48 |          expect(dialog.message()).toContain('Thank you for your purchase!')
