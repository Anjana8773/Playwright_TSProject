...
```
Error: ENOENT: no such file or directory, open 'C:\PlaywrightTS_DemoblazeProject\testdata\application_testdata.xlsx'
```
      ...
      - generic [ref=e4]:
        ...
        - generic [ref=e9]:
          ...
          - generic [ref=e11]:
            ...
            - 'textbox "Total: 790 Name:" [ref=e13]'
          - generic [ref=e14]:
...
```ts
  ...
  17 | 
> 18 |     const workbook=XLSX.readFile('testdata/application_testdata.xlsx')//read file
     |                         ^ Error: ENOENT: no such file or directory, open 'C:\PlaywrightTS_DemoblazeProject\testdata\application_testdata.xlsx'
