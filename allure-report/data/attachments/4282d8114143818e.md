...
- Name: Main.spec.ts >> TC#2 User Registration click close button
- Location: tests\Main.spec.ts:33:5
      ...
      - generic [ref=e4]:
        ...
        - generic [ref=e9]:
          - generic [ref=e10]:
            ...
            - textbox "Username:" [ref=e12]: Disney
          - generic [ref=e13]:
            - generic [ref=e14]: "Password:"
            - textbox "Password:" [active] [ref=e15]: Test@123
        - generic [ref=e17]:
...
```ts
  ...
  14 |         this.page=page
  15 |         this.signuplink=page.locator('#signin2')
  16 |         this.username=page.locator('#sign-username')
  17 |         this.password=page.locator('#sign-password')
  18 |         this.signupbtn=page.getByRole('button',{name:'Sign up'})
  19 |         this.closebtn=page.getByRole('button',{name:'Close'})
  20 | 
  21 |     }
  22 | 
  23 |   
  24 | 
  25 | 
  26 |     async clickSignUpLink(){
  27 |         await this.signuplink.click()
  28 |     }
  29 | 
  30 |     async userRegistrationform(username:string,password:string){
  31 |        
  32 |         await this.username.fill(username)
  33 |         await this.password.fill(password)
  34 |     }
  35 | 
  36 |     async clicksubmitbtn(){
  37 |         await this.signupbtn.click()
  38 |         return this
  39 |     }
  40 | 
  41 |     async clickclosebtn(){
> 42 |         await this.closebtn.click()
     |                             ^ Error: locator.click: Error: strict mode violation: getByRole('button', { name: 'Close' }) resolved to 2 elements:
  43 |         return this
  44 |     }
  45 | 
  46 |     async clickLoginbtn(){
  47 |         await this.signuplink.click()
  48 |     }
  49 | 
  50 | 
  51 | 
