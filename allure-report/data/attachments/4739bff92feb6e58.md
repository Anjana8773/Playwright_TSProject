...
Error: strict mode violation: locator('.modal-body') resolved to 5 elements:
    ...
    3) <div class="modal-body">…</div> aka locator('div').filter({ hasText: 'Total: 10850 Name: Country:' }).nth(3)
  ...
  - dialog "Place order" [ref=e2]:
    - document [ref=e3]:
      - generic [ref=e4]:
        ...
        - generic [ref=e9]:
          - generic [ref=e10]: "Total: 10850"
          - generic [ref=e11]:
            - generic [ref=e12]: "Name:"
            - 'textbox "Total: 10850 Name:" [active] [ref=e13]': John
          - generic [ref=e14]:
          ...
          - row "Iphone 6 32gb 790 Delete" [ref=e177]:
            ...
            - cell "Delete" [ref=e182]:
              - link "Delete" [ref=e183] [cursor=pointer]:
                - /url: "#"
    - generic [ref=e184]:
      - heading "Total" [level=2] [ref=e185]
      - heading "10850" [level=3] [ref=e188]
      - button "Place Order" [ref=e189]
  - generic [ref=e191]:
    - generic [ref=e194]:
      - heading "About Us" [level=4] [ref=e195]
      - paragraph [ref=e196]: We believe performance needs to be validated at every stage of the software development cycle and our open source compatible, massively scalable platform makes that a reality.
    - generic [ref=e199]:
      - heading "Get in Touch" [level=4] [ref=e200]
      - paragraph [ref=e201]: "Address: 2390 El Camino Real"
      - paragraph [ref=e202]: "Phone: +440 123456"
      - paragraph [ref=e203]: "Email: demo@blazemeter.com"
    - heading "PRODUCT STORE" [level=4] [ref=e207]:
      - img [ref=e208]
      - text: PRODUCT STORE
  - contentinfo [ref=e209]:
    - paragraph [ref=e210]: Copyright © Product Store
```
...
> 165 |      expect(page.locator('.modal-body')).toBeVisible()
      |                                          ^ Error: expect(locator).toBeVisible() failed
