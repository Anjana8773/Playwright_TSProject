...
```ts
  ...
  3  | import { generateRandomUsername, generateRandomPassword } from '../utils/randomUtils'
  4  | 
  5  | 
  ...
  14 |     const user = generateRandomUsername()
  15 |     const password = generateRandomPassword()
  16 | 
